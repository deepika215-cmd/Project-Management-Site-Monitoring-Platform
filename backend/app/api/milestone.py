...
MILESTONE_READ_ROLES = ["ADMIN", "PROJECT_MANAGER", "SITE_ENGINEER", "CONTRACTOR", "CLIENT"]
MILESTONE_WRITE_ROLES = ["ADMIN", "PROJECT_MANAGER", "SITE_ENGINEER"]
...
@router.post(
    ...
    dependencies=[Depends(role_required(MILESTONE_WRITE_ROLES))]
)
...
@router.get(
    ...
    dependencies=[Depends(role_required(MILESTONE_READ_ROLES))]
)
def get_milestones(
    db: Session = Depends(get_db)
):
