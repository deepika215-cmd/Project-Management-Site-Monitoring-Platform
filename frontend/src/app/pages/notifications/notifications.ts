...
export class Notifications {
  ...
  notifications: NotificationItem[] = [

    {
      ...
      description:
      'A site safety inspection is scheduled for tomorrow at 10:00 AM.',
...

    {
      ...
      description:
      'The steel beam shipment has been delayed by 2 days.',
...

    {
      ...
      description:
      'Permit renewal is overdue for the East wing project.',
