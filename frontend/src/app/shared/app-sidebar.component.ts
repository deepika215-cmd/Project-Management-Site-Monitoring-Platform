...
export class AppSidebarComponent implements OnInit{
 ...
 canManageResources(){return this.isAdmin()||this.isProjectManager()} canManageWorkforceOps(){return this.isAdmin()||this.isProjectManager()||this.role==='CONTRACTOR'} canViewDocuments(){return this.isAdmin()||this.isProjectManager()||this.isSiteEngineer()||this.role==='CLIENT'} canUseProcurement(){return this.isAdmin()||this.isProjectManager()||this.role==='CONTRACTOR'} canViewBudget(){return this.isAdmin()||this.isProjectManager()||this.isSiteEngineer()||this.role==='CLIENT'} canViewReports(){return this.isAdmin()||this.isProjectManager()||this.isSiteEngineer()||this.role==='CLIENT'} canViewAnalytics(){return this.isAdmin()||this.isProjectManager()}
